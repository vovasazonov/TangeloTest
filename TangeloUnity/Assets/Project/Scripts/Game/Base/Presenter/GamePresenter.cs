...
namespace Project.Scripts.Game.Base.Presenter
{
    public class GamePresenter : IPresenter
    {
        ...
        public GamePresenter(IGameModel model, IGameView view, IPopups popups, ILogger logger)
        {
            var popupsPresenterFactory = new PopupPresenterFactory(model.Popups, model.Browser, logger);
